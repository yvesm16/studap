...
<html>
<head>
    <title>CICS E-Services - Rate Our Services</title>
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        ...
        <p style="margin-top: 5%">
            <p>Thank you for using ESC E-Services in processing your request. Rate your experience while using the website by clicking on the link and help us improve.</p>
        </p>
        <p style="margin-top: 5%">
