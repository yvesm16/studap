...
<script src="{{ URL::asset('js/registrar/global.js'); }}"></script>
<link rel="stylesheet" href="{{ URL::asset('css/registrar/global.css'); }}">
<?php
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li <?php echo (str_contains($actual_link,'home')) ? 'class="active"' : ''; ?>><a href="{{ URL::to('registrar/home'); }} ">Home</a></li>
      ...
      <div class="modal-body">
        ...
        <div class="tab-content">
          ...
          <div id="menu1" class="tab-pane fade" style="padding-top: 1%">
            <form action="{{ URL::to('registrar/uploadSignature') }}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="form-group">
...
<script>
  $(document).ready(function(){
    ...
    $(window).on('load', function() {
      $.ajax({
          url: BASE_URL + '/registrar/getSignature',
          headers: {
