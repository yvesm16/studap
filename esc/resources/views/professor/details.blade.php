                ...
                <div class="modal-content">
                  ...
                  <p >
                    <ul style='text-align:left; margin-right:5%'>
                        ...
                        <b>For the Department Chair:</b><br>
                        ...
                        <li>The approve button places the sign of the department chair</li>
                        <li>The okay button on the modal must be clicked to confirm the approval of the request</li>
                        <li>The decline button shows that the request is disapprove by the department chair</li>
                        <li>The reason modal must be filled out if it is disapproved </li>
                        <li>The submit to dean button is clicked for the request to be transferred the dean</li>
                        <br><br>
