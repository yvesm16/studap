$(document).ready(function() {
  ...
  $('.reserveSlot').on('click', function (){
      var BASE_URL = $("#hdnBaseUrl").val();
      var concerns = [];

      $.ajax({
          url: BASE_URL + '/professor/postSlot',
          headers: {
          ...
          data: {
              ...
              repeat_slot: $("input[name=optradio]:checked").val(),
              slot_end_date: $('#slot_end_date').val()
          },
          dataType    :'json',
...
function renderCalendar(){
  ...
  $.ajax({
      url: BASE_URL + '/professor/getProfessorSchedule',
      headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      },
      type: 'POST',
      data: {
          professorID : $('#professor_id').val()
      },
      dataType    :'json',
      success: function (data) {
